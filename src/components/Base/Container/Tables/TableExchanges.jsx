  ...
  componentDidMount() {
    axios
      ...
      .then(response => {
        ...
        this.setState({ Exchangedata: response, data: DATA });
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell component="th" scope="row" padding="none">
                        <Link
                          to={`/exchangeClicked/${element.name} ,${
                            element.type
                          },${element.durability}`}
                        >
                          {element.name}
                      ...
                      <TableCell numeric>{element.type}</TableCell>
                      <TableCell numeric>{element.durability}</TableCell>

                      <TableCell numeric>{element.permissions}</TableCell>
                    </TableRow>
                  );
                })}
              {/* {data
